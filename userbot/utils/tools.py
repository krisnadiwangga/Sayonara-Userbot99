...
def post_to_telegraph(title, html_format_content):
    ...
    auth_name = "Sayonara-Userbot88"
    auth_url = "https://github.com/krisnadiwangga/Sayonara-Userbot88"
...
async def hadeh_ajg():
    sayo = str(pybase64.b64decode("U2F5b25hcmFTdXBwb3J0"))[2:13]
    userbot = str(pybase64.b64decode("U2F5b25hcmFVcGRhdGU="))[2:13]
    try:
        await bot(Get(sayo))
