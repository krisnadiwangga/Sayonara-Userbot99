...
async def typewriter(typew):
    ...
    sleep(2)
    await typew.edit("**Panda Gajelas☑️**")
    await typew.edit("**panda Gajelas✅**")
    sleep(2)
    await typew.edit("**keyzy goblok!☑️**")
    await typew.edit("**keyzy Goblok banget!✅**")
    sleep(2)
    await typew.edit("**fira kang gabut!☑️**")
    await typew.edit("**fira kang gabut!✅**")
    sleep(2)
