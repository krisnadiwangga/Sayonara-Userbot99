...
async def set_afk(afk_e):
    ...
    if string:
        AFKREASON = string
        await afk_e.edit(f"{REPO_NAME}\n╭✠╼━━━━━━❖━━━━━━━✠╮\n┣ {ALIVE_NAME} __sᴇᴅᴀɴɢ ᴀꜰᴋ​__\n┣ ᴀʟᴀꜱᴀɴ : {AFKREASON}\n╰✠╼━━━━━━❖━━━━━━━✠╯")
    else:
        await afk_e.edit("⚡ᴀꜰᴋ​⚡\n╭✠╼━━━━━━❖━━━━━━━✠╮ \n┣ __sᴇᴅᴀɴɢ ᴀꜰᴋ​__ \n╰✠╼━━━━━━❖━━━━━━━✠╯")
    if user.last_name:
        await afk_e.client(UpdateProfileRequest(first_name=user.first_name, last_name=user.last_name + " ⚡ᴀꜰᴋ​⚡"))
    else:
...
async def type_afk_is_not_true(notafk):
    ...
    if ISAFK:
        ISAFK = False
        msg = await notafk.respond("⚡ᴋᴇᴍʙᴀʟɪ ᴏɴʟɪɴᴇ​⚡")
        time.sleep(3)
        await msg.delete()
